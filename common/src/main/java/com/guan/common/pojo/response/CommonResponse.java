package com.guan.common.pojo.response;


import com.guan.common.enums.response.ApiBaseResponseEnum;
import com.guan.common.enums.response.CommonErrorResponseEnum;
import com.guan.common.enums.response.IResponseEnum;
import lombok.Data;
...
public class CommonResponse<T> extends BaseResponse<T> {
    ...
    public static <T> BaseResponse<T> withSuccess() {
        return withResponse(ApiBaseResponseEnum.SUCCESS);
    }
    ...
    public static <T> BaseResponse<T> withError() {
        return withResponse(CommonErrorResponseEnum.OPTIOPN_ERROR);
    }
