package com.guan.learning.common.interceptor;


import com.guan.learning.common.annotation.RepeatSubmit;
        ...
        if (handler instanceof HandlerMethod) {
            ...
            if (annotation != null) {
                if (this.isRepeatSubmit(request, annotation)) {
                    throw new BusinessException(CommonErrorResponseEnum.SERVER_BUSY, annotation.message());
                }
            }
            return true;
        } else {
